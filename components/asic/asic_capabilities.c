...
static const asic_capabilities_t BZM_CAPABILITIES = {
    .version_rolling = ASIC_VERSION_ROLLING_MIDSTATE,
    .supported_version_mask = BM_SUPPORTED_VERSION_MASK,
    .max_version_variants = 4,
    .supports_ntime_rolling = true,
    .max_ntime_roll = 127,
    .work_refresh_policy = ASIC_WORK_REFRESH_DRIVER_MANAGED,
    .driver_owns_scheduling = true,
};
...
{
    return capabilities != NULL &&
           capabilities->work_refresh_policy == ASIC_WORK_REFRESH_ON_NEW_JOB;
}
